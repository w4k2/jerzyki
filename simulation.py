...
for i in range(n_epochs):
    ...
    kde = KernelDensity(kernel='gaussian').fit(conszlak)
    ...
    aa.contour(a, b, z.reshape(a.shape), cmap='gray', alpha=.25)

    ab.contourf(a, b, z.reshape(a.shape), cmap='terrain', levels=16)
    ...
    aa.scatter(*np.concatenate(szlak).T, s=20, alpha=.1, 
